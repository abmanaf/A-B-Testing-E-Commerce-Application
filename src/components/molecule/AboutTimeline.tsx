      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="lg:sticky lg:top-24 lg:self-start">
          ...
          <p className="mt-4 text-zinc-500 leading-relaxed">
            From a tiny apartment to serving customers in 30+ countries
            here's every milestone that shaped who we are today.
          </p>

          <div className="mt-8 rounded-2xl border border-amber-100 bg-amber-50 p-5">
            <p className="text-sm font-medium text-amber-800">
              "We built e-buy because we believed great products shouldn't
              be a luxury. Five years later, that belief hasn't changed."
            </p>
            <div className="mt-3 flex items-center gap-2">
              ...
              <div>
                <p className="text-xs font-semibold text-zinc-800">Abdul Karim</p>
